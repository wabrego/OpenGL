...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica1_ig.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica1_ig.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica1_ig ${OBJECTFILES} ${LDLIBSOPTIONS} -lassimp -lopengl32 -lglu32 -lglew32 -lfreeglut -lfreeimage
